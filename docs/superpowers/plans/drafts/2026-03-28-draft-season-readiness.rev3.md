...
> Review-only revision for another model. This file incorporates follow-up decisions from review of `2026-03-28-draft-season-readiness.rev2.md` without rewriting the main readiness plan yet.
