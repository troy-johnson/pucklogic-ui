...
> Review-only revision for another model. This file captures the requested changes to `2026-03-28-draft-season-readiness.md` without rewriting the main plan yet.
