...
> Review-only revision for another model. This file incorporates review feedback on `008a-draft-season-readiness.rev1.md` without rewriting the main readiness plan yet.
