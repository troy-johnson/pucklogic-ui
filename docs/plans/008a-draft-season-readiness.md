...
**Canonical UX artifact:** `docs/specs/009-web-draft-kit-ux.md`

**Planning split:**
1. UX workflow/spec planning
2. Screen/wireframe planning
3. Design-system planning

**Key assumptions:**
- Web is the primary launch surface; extension is a later integration surface
- Auth + saved kits are required at launch
- Manual pick entry is a launch-required fallback
- Backend draft session state remains authoritative

**Key decisions needed before implementation:**
- Anonymous vs authenticated kit creation rules
- League profile requirement timing
- Live draft recommendation layout approach
- Suggestion rationale depth at launch
- Session concurrency and resume behavior

**Out of scope:** deep extension implementation, Yahoo-specific UX beyond compatibility constraints, and post-launch optimization work.

### Milestone B approval checklist

- [ ] Approve spec `009-web-draft-kit-ux`
- [ ] Approve the 3-way planning split (workflow/spec, screen/wireframe, design-system)
- [ ] Approve the must-have vs post-launch cut line
- [ ] Resolve open product questions that block implementation sequencing
